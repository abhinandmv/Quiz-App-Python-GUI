...
class QuizInterface:
    def __init__(self,quiz_brain:QuizBrain):
        ...
        self.right_button = Button(image = true_img , highlightthickness=0 , borderwidth=0,command = self.true_pressed)
        self.right_button.grid(column = 0 , row = 2)

        false_img = PhotoImage(file = "images/false.png")
        self.false_button = Button(image = false_img,highlightthickness=0,borderwidth=0,command = self.false_pressed)
